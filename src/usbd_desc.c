...
//#define USBD_PID                      0x5710 // Joystick in FS Mode (normally 0x5710)
...
#define USBD_PRODUCT_FS_STRING        "Nucleo Yoke"
#define USBD_CONFIGURATION_HS_STRING  "Nucleo Yoke Config"
#define USBD_INTERFACE_HS_STRING      "Nucleo Yoke Interface"
#define USBD_CONFIGURATION_FS_STRING  "Nucleo Yoke Config"
#define USBD_INTERFACE_FS_STRING      "Nucleo Yoke Interface"
...
__ALIGN_BEGIN   uint8_t USBD_DeviceDesc[USB_LEN_DEV_DESC] __ALIGN_END = {
  ...
  0x00,                       /* bcdUSB */
  0x02,
  0x00,                       /* bDeviceClass, 0x00-HID, 0x02-CDC */
  0x00,                       /* bDeviceSubClas, 0x00-HID, 0x02-CDCs */
